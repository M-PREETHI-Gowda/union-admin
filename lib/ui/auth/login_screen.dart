...
import 'package:admin_app/helpers/custom_snackbar.dart';
import 'package:admin_app/helpers/reuse_widget.dart';
import 'package:admin_app/ui/user_dashboard/index.dart';
      ...
      body: BlocListener<LoginBloc, LoginState>(
        listener: (context, state) {
          if(state is LoginLoading){
            ...
            CustomSnackBar.showCustomSnackBar(context: context, title: state.message);
            loading = false;
        ...
        child: enableButton(
          ...
          onPressed: (loading == true)
            ...
            if (_formKey.currentState!.validate()) {
              loginBloc.add(LoginEvents( memberId: memberId, password: passcode));
            }
          },
          text: "Log in",
        ),
